...
<?php
	...
	{
    $head='<a style="color:red;"><i class="fa fa-first-order"></i>&nbsp;&nbsp;Orders</a>';
		?>
    ...
    $order_status='Delivered';
		$query="SELECT * FROM pending_orders WHERE product_seller=:product_seller ORDER BY order_status=:order_status";
		$run_query=$pdo->prepare($query);
    $run_query->bindParam(':product_seller',$seller_email,PDO::PARAM_STR);
    $run_query->bindParam(':order_status',$order_status,PDO::PARAM_STR);
    $run_query->execute();
    ...
    $row=$run_query->fetchAll(PDO::FETCH_ASSOC);
						...
						echo '
							...
							<div class="detailing">
								...
								<div class="pro_info">
									...
									<div class="pro_titls">&#x20B9 '.$price.' | SIZE: '.$product_size.'</div><br>
                  <div class="pro_titls">From: '.$customer_email.'</div></br>';
        ...
        <div class="noitems">
      		<div class="icon">
      			<i class="fas fa-first-order" id="icons"></i></a>
      		</div>
      		<div class="items" style="color:#a6a6a6;">
      		You do not have any orders.
      		</div>
      		<div class="go">
      			<a href="index.php?dashboard">Go to Dashboard</a>
      		</div>
